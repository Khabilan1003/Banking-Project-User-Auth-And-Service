...
public class UserResponseModel {
	...
	public UserResponseModel(Integer userId, String firstname, String lastname, String username, Branch branch,
	...
	public String toString() {
		return "UserResponseModel [userId=" + userId + ", firstname=" + firstname + ", lastname=" + lastname
				+ ", username=" + username + ", branch=" + branch + ", roles=" + roles + ", phoneNumber=" + phoneNumber
				+ ", email=" + email + "]";
	}
}
